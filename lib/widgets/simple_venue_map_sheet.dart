...
/// Lightweight OpenStreetMap bottom sheet for match venues.
/// Uses raw lat/lng — no Venue entity required.
class SimpleVenueMapSheet extends StatelessWidget {
  final String name;
  final double latitude;
  final double longitude;

  const SimpleVenueMapSheet({
    super.key,
    required this.name,
